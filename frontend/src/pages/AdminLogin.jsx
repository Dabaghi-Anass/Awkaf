            ...
            <>
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1 custom-input"
                />
                {otpError && <p className="text-red-500 text-[0.7em] mt-1">{otpError}</p>}
              </div>
              <button type="submit" className="w-full bg-green-500 text-white py-1 rounded-md hover:bg-green-600 transition">
                تحقق من OTP
              </button>
            </>
          )}
