  ...
  const testimonials = [
    {
      ...
      role: 'رجل أعمال',
      content:
        'منصة ممتازة ودقيقة في الحسابات، سهلت علي كثيراً حساب زكاة أموالي',
      rating: 5,
    },
    {
      name: 'فاطمة العلي',
  ...
  const newsItems = [
    {
      ...
      excerpt:
        'أضافت المنصة معايير جديدة لحساب الزكاة وفقاً لآخر الفتاوى الشرعية المعتمدة...',
    },
    {
      date: '2025-01-10',
      title: 'ورشة تعليمية مجانية حول أحكام زكاة الأموال',
      excerpt:
        'تنظم المنصة ورشة تعليمية مجانية للتعريف بأحكام الزكاة وطرق حسابها الصحيحة...',
    },
    {
      date: '2025-01-05',
      title: 'إطلاق خدمة الاستشارات الشرعية المجانية',
      excerpt:
        'يمكن للمستخدمين الآن الحصول على استشارات شرعية مجانية حول أحكام الزكاة...',
    },
  ];
        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
            {services.map((service, index) => (
              <Link key={index} to='/calculator' className='group'>
                <div
                  className={`bg-gradient-to-br ${service.color} rounded-2xl p-6 text-white transform transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl`}
                >
      ...
      <section className='py-16 lg:py-20 bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-600 text-white'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-lg lg:text-xl mb-8 text-emerald-100 max-w-2xl mx-auto leading-relaxed'>
            انضم إلى آلاف المستخدمين الذين يثقون في منصتنا لحساب زكاة أموالهم
            بدقة وموثوقية
          </p>
