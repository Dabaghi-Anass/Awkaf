...
export const ZakatPrice = () => {
	...
	const { zakatFormInfos, setShowResult, saveZakatHistory, nissab } =
					...
					<div className='p-4 text-sm'>
						...
						<div className='space-y-3 mb-4'>
							<div className='bg-emerald-50 border border-emerald-200 rounded-lg p-3 flex justify-between max-[510px]:justify-evenly max-[510px]:p-1 max-[510px]:rounded-sm'>
								...
								<span className='text-emerald-700 font-bold max-[510px]:text-xs'>
									{formatNumber(zakatFormInfos.zakatAmount)}{" "}
									{language === "ar" ? "د.ج" : "DZD"}
								</span>
							</div>
						...
						<div className='space-y-2 mb-4'>
							...
							<div className='flex justify-between mx-auto bg-gray-200 p-2 rounded max-[510px]:text-xs max-[510px]:w-[80%]'>
								...
								<span className='font-bold'>
									{formatNumber(zakatFormInfos.totalAmount)}{" "}
									{language === "ar" ? "د.ج" : "DZD"}
								</span>
							</div>
							<div className='flex justify-between mx-auto bg-gray-200 p-2 rounded max-[510px]:text-xs max-[510px]:w-[80%]'>
						...
						{/* Contact Notice */}
						<div
							className={`bg-blue-50 border border-blue-200 rounded p-2 mb-4 text-xs ${language === "ar" ? "text-right" : "text-left"}`}>
							{t("zakatResult.contactNotice")}{" "}
							<Link
								to='/contact'
								className='text-green3 font-bold hover:underline'>
