        ...
        <div key={index} className='my-2'>
          {field.children && field.children.length > 0 ? (
            <div className='bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg overflow-hidden '>
              ...
              >
                <div className='flex items-center'>
                  <div
                    className={`w-1 h-6 bg-emerald-600 ${language === 'ar' ? 'ml-3' : 'mr-3'} rounded-full`}
                  ></div>
            ...
            <div className='cal-input-bg'>
              <div className='flex items-center justify-between mb-3'>
                <label className='font-semibold text-gray-700 text-sm flex-1 max-[515px]:text-xs'>
                  ...
                  {additionalFields[field.name] &&
                    additionalFields[field.name].length > 0 && (
                      <span className='text-xs text-emerald-600 font-normal mr-2'>
                        ({t('ui.total')}:{' '}
                        {formatNumber(
                          calculateTotalForField(field.name, field.value)
                        )}{' '}
                        ){/* {language === 'ar' ? 'د.ج' : 'DZD'}) */}
                      </span>
                    )}
              ...
              {additionalFields[field.name] &&
                additionalFields[field.name].map((additionalField, idx) => (
                  <div
                  ...
                  >
                    <div className='flex items-center'>
                      ...
                      <button
                        type='button'
                        onClick={() =>
                          removeField(field.name, additionalField.id)
                        }
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden'>
            <div className='form-header bg-gradient-to-r from-gray-50 to-emerald-50 border-b max-[515px]:p-4 border-gray-200 p-6'>
              <div className='flex items-center'>
                <div
                  className={`w-3 h-8 bg-emerald-600 ${language === 'ar' ? 'ml-4' : 'mr-4'} rounded-full`}
                ></div>
                <div>
            ...
            <div className='p-8 form-container'>
              <div className='form-cont2 mb-3'>
                <div className='flex items-center mb-4'>
                  <div
                    className={`w-1 h-6 bg-blue-600 ${language === 'ar' ? 'ml-3' : 'mr-3'} rounded-full`}
                  ></div>
