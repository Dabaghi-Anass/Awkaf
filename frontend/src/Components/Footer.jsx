            ...
            <div className='lg:col-span-1'>
              <div className='mb-8'>
                <h1 className='text-2xl font-bold text-white leading-tight mb-6'>
                  منصة حساب زكاة الشركات
                  <br />
                  وتوجيهها للوقف والتنمية
                </h1>
                <p className='text-gray-300 leading-relaxed text-lg'>
                  منصة إسلامية متخصصة في حساب وتوجيه الزكاة لخدمة المجتمع وتحقيق
                  التنمية المستدامة
                </p>
              </div>
              ...
              {/* <div>
                ...
                <div className='flex space-x-4'>
                  <a
                    href='#'
                    className='w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors duration-300 group'
                  >
                    <svg
                  ...
                  <a
                    href='#'
                    className='w-12 h-12 bg-blue-800 rounded-full flex items-center justify-center hover:bg-blue-900 transition-colors duration-300 group'
                  >
                    <svg
                  ...
                  <a
                    href='#'
                    className='w-12 h-12 bg-red-600 rounded-full flex items-center justify-center hover:bg-red-700 transition-colors duration-300 group'
                  >
                    <svg
                      className='w-5 h-5 text-white group-hover:scale-110 transition-transform'
                      fill='currentColor'
              ...
              <div className='grid md:grid-cols-2 gap-8'>
                ...
                <div>
                  <h3 className='text-xl font-bold text-white mb-6 flex items-center'>
                    <svg
                      className='w-6 h-6 ml-3 text-green-400'
                      fill='currentColor'
                      viewBox='0 0 20 20'
                    >
                      <path
