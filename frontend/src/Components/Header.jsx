    ...
    >
      <nav className=" flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 py-3 md:py-4">
        ...
        <button
          ...
          className="hidden md:inline-block text-xs lg:text-sm px-4 lg:px-6 py-2 bg-green-400 hover:bg-green-500 rounded-full font-medium transition-all duration-300 hover:shadow-lg flex-shrink-0"
        >
          تسجيل الخروج
        </button>
