				...
				<Tooltip className='max-w-xs whitespace-normal text-sm leading-relaxed'>
					...
					<TooltipContent className='bg-emerald-600 text-white border-emerald-700 max-w-sm'>
						<p className='text-sm leading-relaxed'>
							...
							elit. Tempora mollitia perspiciatis, quas esse
							placeat accusantium ipsa sed, voluptas aut, quae
							modi! Molestiae, voluptatem inventore! Velit vitae
							rerum dolorem voluptatum culpa. Lorem, ipsum dolor
							sit amet consectetur adipisicing elit. Harum
							doloremque repellat eaque deleniti distinctio rem
							nihil perspiciatis! Consectetur neque deleniti iste
							in eveniet. Dolores ab eligendi magni atque facere
							dolor.
						</p>
					</TooltipContent>
				</Tooltip>
